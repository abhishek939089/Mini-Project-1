    ...
    return (
        ...
        <div>
            ...
            {!localStorage.getItem('token') ?
                  <button class="btn btn-outline-success"  onClick={handlelogin}>Login to Add Product</button>:
                  <button class="btn btn-outline-success"  onClick={addproduct}>Add Product</button> }
